 ...
 * @return
 *     NULL if reached the end of the list, the iterator is at an invalid state
 ...
 *     LIST_OUT_OF_MEMORY if an allocation failed (Meaning the function for
 ...
 *     A List containing only elements from list which filterElement returned
 *     true for.
 */
